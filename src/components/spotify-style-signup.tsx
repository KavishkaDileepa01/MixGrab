...
export function SpotifyStyleSignup() {
  ...
  const onSocial = useCallback((name: string) => {
    setNotice(`${name} sign-up is not enabled in this demo.`);
  ...
  return (
    <div className="relative flex min-h-full flex-col bg-[#121212] text-white">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(0, 123, 255, 0.1), transparent 50%)",
        }}
        aria-hidden
      />
        ...
        <div className="auth-card-animate w-full max-w-[28rem] space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-neutral-400">
              Demo only — registration is disabled. Submit takes you to the
              downloader home.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div className="space-y-1.5">
              <label htmlFor="su-email" className="text-sm font-medium text-white">
                Email
              </label>
              <input
                id="su-email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="su-password" className="text-sm font-medium text-white">
                Password
              </label>
